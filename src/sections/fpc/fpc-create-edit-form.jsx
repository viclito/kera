  ...
  const defaultValues = useMemo(
    () => ({
      ...
      member_categories: [
        {
          ...
          total_number: null,
          male_percentage: '.63',
          female_percentage: '114.5',
          transgender_percentage: '728',
          total_percentage: '02.67',
        },
        {
      ...
      rating_matrix: {
        ...
        audit_status: '',
        share_allotment_updated: true,
        has_ceo: true,
        has_accountant: true,
        has_ca_cs: true,
        has_seed_license: true,
        has_fertilizer_license: true,
        ...
        has_warehouse_facility: true,
        turnover_range: '',
        convergence_scheme_count: '',
        loan_status: 'none',
        has_regular_repayment: true,
      },
    }),
    []
  );
